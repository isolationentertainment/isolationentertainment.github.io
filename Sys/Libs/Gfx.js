...
var _isGameView = /DsGameView/i.test(navigator.userAgent);
...
var gfx = new function Gfx()
{
    ...
    this._checkReady = function()
    {
        ...
        for( var s in JGAudio._loaded ) 
            if( JGAudio._loaded[s].loaded==false ) ready = false;
    ...
    { 
        ...
        else if( _isGameView ) prompt( "#", "App.Execute("+js );
    }
    ...
    { 
        ...
        else if( _isGameView )  prompt( "#", "App.Vibrate("+pattern );
    }
    ...
    function Sprite()
    {
        var _this = this; this.visible=true; this.loaded = false; this.added = false;
