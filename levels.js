...
function UpdateScore(points)
{
    ...
    else if(scoreCounter >= 30000 && scoreCounter < 40000) level = 4 //boss
    ...
    else if(scoreCounter >= 70000 && scoreCounter < 80000) level = 8 //boss
    else if(scoreCounter >= 80000 && scoreCounter < 90000) level = 9
    else if(scoreCounter >= 90000 && scoreCounter < 100000) level = 10
    else if(scoreCounter >= 100000 && scoreCounter < 110000) level = 11 
    else if(scoreCounter >= 110000 && scoreCounter < 120000) level = 12 //boss
    else if(scoreCounter >= 120000 && scoreCounter < 1000000) level = 13
